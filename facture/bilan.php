		...
		$.ajax({
			...
			success : function(data){
				...
				for(i=0;i<obj.length;i++){
					...
					buffer2=buffer2 + '<li><a href="rd.php?millesime='+ tmp[0] + '"  rel="external" data-rel="dialog" data-transition="pop" >';
					buffer2=buffer2 + '<h3>Abonnés : ' + tmp[1] + '</h3>';
					buffer2=buffer2 + '<p>Représente : ' + tmp[2] + ' Euros</p>';
