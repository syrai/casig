...
//Requete SQL
$requete="select tcy.id_cycle,tc.idexploitation,tc.raison_social as exploitation,ta.adresse as rue, ta.codepostal, ta.commune from tformation tf ";
...
while($row = pg_fetch_array($result)) {
        $excel .= "$row[exploitation];$row[rue];$row[codepostal];$row[commune]\n";
}
